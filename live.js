...
(function (glob) {
  ...
  const SPEC = {
    ...
    mantenimiento: { semana: ['semana'], preventivos: ['preventivos'], correctivos: ['correctivos'], ups: ['ups'], switch: ['switch'], accessPoint: ['access point', 'access'], garantias: ['garant'], resueltas: ['resueltas'] },
    anchosBanda: { semana: ['semana'], bloque: ['bloque'], noCumpleVT: ['no cumple vt'], cumpleVT: ['cumple vt'], sinVerificarVT: ['sin verificar'], noCumpleTeorico: ['no cumple teorico'], cumpleTeorico: ['cumple teorico'], noContrato: ['no contrato', 'contrato'] },
  ...
  const PLAN = [
    ...
    { key: 'anchosBanda', fn: r => blockSheet(r, SPEC.anchosBanda, ['no cumple vt']) },
