...
(function (glob) {
  ...
  const SPEC = {
    ...
    anchosBanda: { semana: ['semana'], bloque: ['bloque'], noCumpleVT: ['no cumple por visita tecnica', 'no cumple vt'], cumpleVT: ['cumple por visita tecnica', 'cumple vt'], sinVerificarVT: ['sin verificar por visita tecnica', 'sin verificar'], noCumpleTeorico: ['no cumple teorico'], cumpleTeorico: ['cumple teorico'], noContrato: ['no contrato', 'contrato'] },
  ...
  const PLAN = [
    ...
    { key: 'anchosBanda', fn: r => blockSheet(r, SPEC.anchosBanda, ['bloque', 'teorico']) },
